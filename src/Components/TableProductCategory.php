...
#[AsLiveComponent("tableProductCategory")]
class TableProductCategory extends AbstractController{
    ...
    public function deleteItem(#[LiveArg()] int $id){
        $product = $this -> productCategoryRepository -> findOneBy(["id" => $id]);
    ...
    public function filteredData(){
        $data=  $this -> productCategoryRepository -> createQueryBuilder("q")    
