...
use App\Form\ShowCaseImagesType;
...
class ShowCaseImagesController extends AbstractController
{
    #[Route('/show/case/images', name: 'app_admin_show_case_images')]
    public function index(Request $request, EntityManagerInterface $manager, ShowCaseImagesRepository $showCaseImagesRepository): Response
    {
        $error = null;
        $images = null;
        $tab_server = null;
        if ($this->getUser() && $this->getUser()->getRoles()[0] == "ROLE_ADMIN") {
            $id = $this->getUser();
            $homePageSection = $showCaseImagesRepository->findOneBy(["factory" => $id->getFactory()]);
            
            $homeSection = new ShowCaseImages();

            $form = $this->createForm(ShowCaseImagesType::class, $homeSection);
            ...
            return $this->render('show_case_images/index.html.twig', [
    ...
    #[Route('/show/case/images/edit-{id}', name: 'app_admin_show_case_images_edit')]
    public function edit(int $id , Request $request, EntityManagerInterface $manager, ShowCaseImagesRepository $showCaseImagesRepository): Response
    {
        $error = null;
        $images = null;
        $tab_server = null;
        if ($this->getUser() && $this->getUser()->getRoles()[0] == "ROLE_ADMIN") {
            ...
            $homePageSection = $showCaseImagesRepository->findOneBy(["id" => $id]);
            $images = $homePageSection->getImageName();

            $form = $this->createForm(ShowCaseImagesType::class, $homePageSection);
            ...
            return $this->render('show_case_images/edit.html.twig', [
